# pipelines/knife/pipeline.py

"""
File Use:
    YOLO-based knife detection pipeline.
    Detects knives in video frames and flags violations.
...
class knifePipeline(BasePipeline):
    """YOLO pipeline for detecting knives."""

    def __init__(self, config: dict) -> None:
        """Initialize the knife detection pipeline."""

        self._pipeline_id: str = config.get("pipeline_id", "knife")
        ...
        self._logger = get_logger("knife_pipeline", pipeline_id=self._pipeline_id)
    ...
    def process(self, frame_packet: FramePacket) -> PipelineResult:
        """Run knife detection on a single frame."""
